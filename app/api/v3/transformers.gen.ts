...
import type { V3CreateCheckoutResponse, V3CreateTagResponse, V3EvaluateWorkspaceTagsResponse, V3GetActiveDiscountsResponse, V3GetLanguageRankingResponse, V3GetLeaderboardResponse, V3GetSelfOverallRankResponse, V3GetSelfTopLanguagesRankResponse, V3GetTagHistoryResponse, V3GetTagResponse, V3GetTagsResponse, V3GetTagTimeStatsResponse, V3GetTotalMinutesResponse, V3GetUserByUserIdResponse, V3GetUserCodingHistoryResponse, V3GetUserLanguageRankResponse, V3GetUserOverallRankResponse, V3GetUserSelfResponse, V3GetUserTopLanguagesRankResponse, V3UpdateBioResponse, V3UpdateTagResponse } from './types.gen';
...
export const v3UpdateBioResponseTransformer = async (data: any): Promise<V3UpdateBioResponse> => {
    data = userSelfPublicSchemaResponseTransformer(data);
    return data;
};
