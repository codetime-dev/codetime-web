 ...
 */
export const v3UpdateBio = <ThrowOnError extends boolean = false>(options: Options<V3UpdateBioData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<V3UpdateBioResponses, V3UpdateBioErrors, ThrowOnError>({
