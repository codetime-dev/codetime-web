...
<template>
  <div
    class="text-neutral-900 p-10 bg-white h-full w-full items-center justify-center relative dark:text-neutral-50 lg:p-[60px] dark:bg-neutral-900"
  >
    <!-- Gradient background -->
    <div
      class="bottom-0 left-0 right-0 top-0 absolute" :style="{
    ...
    <div class="text-center flex-col gap-5 w-full items-center justify-center relative lg:gap-8">
      <!-- Logo -->
      ...
      <!-- Title -->
      <h1
        class="text-[48px] leading-tight font-bold m-0 text-center max-w-[700px] w-full justify-center lg:text-[80px] lg:max-w-[1000px]"
      ...
      <!-- Description -->
      <p v-if="description" class="text-[24px] leading-relaxed opacity-70 max-w-[650px] lg:text-[32px] lg:max-w-[900px]" style="display: block; line-clamp: 2; text-overflow: ellipsis;">
        {{ description }}
      </p>
    </div>
  </div>
